...
namespace InternetArcade.Classes.ChromeTabControl.ChromeStyle
{
    [System.ComponentModel.ToolboxItem(false)]

    public class ChromeTab : TabStyleProvider
    {

        public ChromeTab(CustomTabControl tabControl) : base(tabControl)
        {
            this._Overlap = 16;
            this._Radius = 16;
