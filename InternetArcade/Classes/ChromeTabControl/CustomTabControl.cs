...
namespace InternetArcade.Classes.ChromeTabControl
{
    ...
    public class CustomTabControl : TabControl
    {
        ...
        public TabStyleProvider DisplayStyleProvider
        {
            get
            {
                if (this._StyleProvider == null)
                {
                    this.DisplayStyle = TabStyle.Chrome;
                }
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                ...
                if (this._Style == TabStyle.Chrome)
                {
        ...
        public class TabSwitching : CustomTabControl
        {
            /// <summary> 
